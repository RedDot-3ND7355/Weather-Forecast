...
export const Route = createRootRoute({
  ...
  head: () => ({
    ...
    links: [
      { rel: "icon", type: "image/png", sizes: "512x512", href: "/icons/vane-512.png" },
      { rel: "icon", type: "image/png", sizes: "256x256", href: "/icons/vane-256.png" },
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/icons/vane-192.png" },
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/icons/vane-32.png" },
      { rel: "shortcut icon", href: "/favicon.ico" },
      { rel: "icon", type: "image/svg+xml", href: "/favicon.svg" },
      { rel: "stylesheet", href: appCss },
      { rel: "manifest", href: "/__grok/manifest.webmanifest?v=4" },
