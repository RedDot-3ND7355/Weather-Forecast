...
import { t as authMiddleware } from "./middleware-B4FBpWre.mjs";
import { C as Bookmark, S as CloudDrizzle, _ as CloudSun, a as Sun, b as CloudLightning, c as MapPin, d as LoaderCircle, f as Info, g as Cloud, h as Droplets, i as Thermometer, l as LogIn, m as Eye, n as Wind, o as Search, p as Gauge, s as Moon, t as X, u as Locate, v as CloudSnow, w as BookmarkCheck, x as CloudFog, y as CloudRain } from "../_libs/lucide-react.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { n as createSsrRpc } from "./router-DFjuOQGE.mjs";
import { n as create, t as persist } from "../_libs/zustand.mjs";
import { a as CartesianGrid, i as Area, n as YAxis, o as ResponsiveContainer, r as XAxis, s as Tooltip, t as AreaChart } from "../_libs/recharts+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Y7UW0krw.js
...
function AppHeader({ onLocate, locating, saved, onSaved }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex max-w-6xl flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:gap-4 sm:px-6",
			children: [
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: ["metric", "imperial"].map((u) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => setUnits(u),
								className: cn("h-9 min-w-10 rounded-full px-2.5 text-xs font-medium", units === u ? "bg-accent text-accent-fg" : "text-muted"),
								"aria-pressed": units === u,
								children: u === "metric" ? "°C" : "°F"
							}, u))
						}),
						isPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "size-11 shrink-0 rounded-full bg-raised" }) : user ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function Compass({ windDir, windSpeedLabel, chance, className }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("relative mx-auto aspect-square w-full max-w-[20rem]", className),
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "font-display text-4xl font-medium tabular-nums leading-none tracking-tight text-fg",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "font-display text-6xl leading-none font-medium tracking-tight tabular-nums text-fg sm:text-7xl",
					children: [formatTemp(current.temperatureC, units), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "ml-1 align-top font-sans text-lg font-medium text-muted",
			...
			children: days.map((d, i) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-right text-sm tabular-nums text-fg",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: hours.map((h, i) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: cn("flex w-[4.4rem] shrink-0 flex-col items-center gap-1.5 rounded-xl px-1.5 py-2.5", i === 0 ? "bg-raised" : ""),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppHeader, {
			...
			children: [hydrated && (savedPlaces.length > 0 || recent.length > 0) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				className: "grid gap-4 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.15fr)]",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "rounded-2xl bg-surface p-5 shadow-[var(--shadow-border)] lg:p-6",
...
function EmptyState({ onPick, onLocate, locating }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mx-auto max-w-xl py-6 text-center sm:py-12",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function HowItWorks({ compact = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: compact ? "mt-12 text-left text-sm text-muted" : "rounded-2xl bg-surface p-5 text-sm text-muted shadow-[var(--shadow-border)] lg:col-span-2",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
			className: "text-[11px] font-medium uppercase tracking-[0.16em] text-faint",
